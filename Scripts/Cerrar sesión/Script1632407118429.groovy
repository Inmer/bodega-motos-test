...
WebUI.click(findTestObject('Object Repository/Page_Bodega Motocicletas/i_admin_fas fa-user-times'))

WebUI.click(findTestObject('Object Repository/Page_Bodega Motocicletas/html_Bodega Motocicletas                   _fd86e9'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Bodega Motocicletas/h4_Login'), 'Login')
